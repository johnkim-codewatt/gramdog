...
Printer* (Henry Frowde); Chicago University Press, *Manual of Style_;
...
Authors* (United States Geological Survey); John Lesslie Hall, *English
Usage* (Scott, Foresman and Co.); James P. Kelley, *Workmanship in
...
*-is*, the possessive *Jesus'*, and such forms as _for conscience'
sake*, *for righteousness' sake*. But such forms as *Achilles' heel_,
...
voice for some such perfunctory expression as *there is*, or _could be
heard_.
...
> The *Iliad*; the *Odyssey*; *As You Like It*; *To a Skylark*; _The
> Newcomes*; *A Tale of Two Cities*; Dickens's *Tale of Two Cities_.
...
still others, as *case*, *factor*, *feature*, *interesting*, _one of the
...
Takes the infinitive without *to*. The past tense in the sense,
"ordered," is *bade*.
...
The *Concise Oxford Dictionary* begins its definition of this
...
See Wood, *Suggestions to Authors*, pp. 68-71, and Quiller-Couch, _The
...
With object-noun, means *lay claim to*. May be used with a
...
Not followed by *as* when it means "believe to be." "I
...
A plural, like *phenomena* and *strata*.
...
Not permissible. Substitute *different from*, _other
than*, or *unlike_.


### Divided into

Not to be misused for *composed of*. The line is
...
Contraction of *do not*. The contraction of *does not* is
*doesn't*.


### Due to

Incorrectly used for *through*, *because of*, or *owing to*,
...
A collective noun, equivalent to *people*. Use the singular form
only.


### Effect

As noun, means *result*; as verb, means *to bring about*,
...
Equivalent to *and the rest*, *and so forth*, and hence not to be
...
Another hackneyed word; like *factor* it usually adds nothing
...
Colloquial in America for *arrange*, *prepare*, *mend*. In
writing restrict it to its literary senses, *fasten*, _make firm or
immovable_, etc.


### Get

The colloquial *have got* for *have* should not be used in
...
In the meaning *nevertheless*, not to come first in its
sentence or clause.
...
When *however* comes first, it means *in whatever way* or _to whatever
extent_.
...
Not to be used as a substitute for *rather* (before
...
Not to be misused for *as*. *Like* governs nouns and pronouns;
...
*Line* in the sense of *course of procedure*,
...
Meant to be more emphatic than *lose*, but actually less so,
...
Retain the *and* in this and similar expressions,
...
*The people* is a political term, not to be confused with _the
...
The future tense requires *shall* for the first person,
...
Avoid, in writing, the use of *so* as an intensifier: "so good;"
...
Avoid the indiscriminate use of this word for *and*, *but*, and
...
Often incorrectly used for *who* before *he said* or similar
...
A conditional statement in the first person requires *should*,
not *would*.
